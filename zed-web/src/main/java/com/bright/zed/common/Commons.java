...
public final class Commons {
     ...
     * @return str
     */
    public static String getSiteIndex() {
        return "index";
    }
    ...
    public static String getSiteUrl(String sub) {
        return getSiteOption("getSiteUrl") + sub;
    }
     ...
     * @return
     */
    public static String getSiteOption(String key, String defalutValue) {
    ...
    public static String theme_url() {
        return getSiteUrl(Commons.THEME);
    }
    ...
    public static String theme_url(String sub) {
        return getSiteUrl(Commons.THEME + sub);
    }
    ...
    public static String random(int max, String str) {
        return IdUtil.random(1,max) + str;
    }
